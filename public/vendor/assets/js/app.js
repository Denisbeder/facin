  ...
  return {
    init: function init() {
      ...
      this.$nextTick(function () {
        Flatpickr(_this.$refs.date, {
          dateFormat: "d/m/Y"
        });
        Flatpickr(_this.$refs.time, {
          inline: true,
          enableTime: true,
          noCalendar: true,
          dateFormat: "H:i",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (startElementSelector, endElementSelector) {
  return {
    startElement: null,
    endElement: null,
    getElement: function getElement(elementSelector) {
      return document.querySelector("[name=\"".concat(elementSelector, "\"]"));
    },
    getFlatpickr: function getFlatpickr(elementField) {
      return elementField._flatpickr;
    },
    startDateFlatpickr: function startDateFlatpickr() {
      return this.getFlatpickr(this.startElement.dateField);
    },
    startTimeFlatpickr: function startTimeFlatpickr() {
      return this.getFlatpickr(this.startElement.timeField);
    },
    endDateFlatpickr: function endDateFlatpickr() {
      return this.getFlatpickr(this.endElement.dateField);
    },
    endTimeFlatpickr: function endTimeFlatpickr() {
    ...
    formatTimeValue: function formatTimeValue(hourValue, minuteValue) {
      return "".concat(hourValue, ":").concat(minuteValue);
    },
    setElements: function setElements(startElementSelector, endElementSelector) {
      this.startElement = {
        dateField: this.getElement("".concat(startElementSelector, "[date]")),
        timeField: this.getElement("".concat(startElementSelector, "[time]"))
      };
      this.endElement = {
        dateField: this.getElement("".concat(endElementSelector, "[date]")),
    ...
    handleStartFields: function handleStartFields() {
      ...
      this.startDateFlatpickr().config.onChange.push(function (selected, currentValue, instance) {
    ...
    handleEndFields: function handleEndFields() {
      ...
      this.endDateFlatpickr().config.onChange.push(function (selected, currentValue, instance) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                // wait DOM 
                _this3.setElements(startElementSelector, endElementSelector); // Start Fields Handle


                _this3.handleStartFields(); // End Fields Handle


                _this3.handleEndFields();
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sidebar */ "./resources/js/store/sidebar.js");


alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('sidebar', _sidebar__WEBPACK_IMPORTED_MODULE_1__["default"]);

/***/ }),

/***/ "./resources/js/store/sidebar.js":
/*!***************************************!*\
  !*** ./resources/js/store/sidebar.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  isModeFull: function isModeFull() {
    return this.mode === "full";
  },
  isModeBar: function isModeBar() {
    return this.mode === "bar";
  },
  isModeMobile: function isModeMobile() {
  ...
  setMode: function setMode() {
    ...
    var defaultMode = window.innerWidth < 1366 ? 'bar' : 'full';
    var storageMode = (_localStorage$getItem = localStorage.getItem("sidebarMode")) !== null && _localStorage$getItem !== void 0 ? _localStorage$getItem : defaultMode;
    var currentMode = this.mode === null || !this.isMobile() ? storageMode : this.mode;
...
/***/ "./resources/js/utils/flatpickr.js":
/*!*****************************************!*\
  !*** ./resources/js/utils/flatpickr.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _choices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./choices */ "./resources/js/utils/choices.js");
/* harmony import */ var _flatpickr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./flatpickr */ "./resources/js/utils/flatpickr.js");
...
/******/ 		var installedChunks = {
/******/ 			"/vendor/assets/js/app": 0,
/******/ 			"vendor/assets/css/app": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["vendor/assets/css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor/assets/css/app"], () => (__webpack_require__("./resources/scss/app.scss")))
