...
@php
    ...
    $classList = [
        'text-blue-600 border-slate-200 rounded focus:ring-offset-0 transition-colors duration-300',
...
<label class="inline-flex items-center cursor-pointer">
    ...
    <input type="checkbox" name="{{ $name }}" {{ $attributes->merge(['class' => Arr::toCssClasses($classList)]) }}>
