    ...
    <div class="card card-bordered bg-base-100">
        ...
        <div x-data="{ expanded: false }">
            <div class="flex items-center justify-center h-px z-10">
                <button class="btn btn-outline border-base-200 hover:border-base-content/20 text-base-content/50 hover:text-base-content/60 bg-base-100 hover:bg-base-100 btn-xs" x-on:click="expanded = !expanded">Mais opções</button>
            </div>
