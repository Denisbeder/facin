            ...
            <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
                ...
                <div class="mt-5 h-0 flex-1 overflow-y-auto">
                    <nav class="space-y-1 px-2">
                        ...
                        <a href="#"
                           class="text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
        ...
        <div class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-white pt-5">
            ...
            <div class="mt-5 flex flex-grow flex-col">
                <nav class="flex-1 space-y-1 px-2 pb-4">
                    <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900" -->
                    <a href="#"
                    ...
                    <a href="#"
                       class="text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <!-- Heroicon name: outline/users -->
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div x-data x-menu class="relative ml-3">
                        ...
                        <div
                            ...
                            <a x-menu:item href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors" role="menuitem" tabindex="-1"
